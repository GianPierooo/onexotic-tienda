...
const variants: Record<Variant, string> = {
  fire: 'bg-fire text-on-fire hover:bg-fire-dim shadow-[0_10px_30px_-12px_rgba(184,20,20,0.7)]',
  ghost:
    'bg-transparent text-fg border border-border hover:border-silver hover:text-silver',
